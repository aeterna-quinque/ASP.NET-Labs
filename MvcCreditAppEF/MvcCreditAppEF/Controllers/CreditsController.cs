...
namespace MvcCreditAppEF.Controllers
{
    public class CreditsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CreditId,Head,Period,Sum,Percent")] Credit credit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CreditId,Head,Period,Sum,Percent")] Credit credit)
        {
